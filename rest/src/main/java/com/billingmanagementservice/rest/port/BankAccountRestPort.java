package com.billingmanagementservice.rest.port;

import com.billingmanagementservice.rest.dto.Transaction;
import com.billingmanagementservice.rest.dto.TransactionData;
import com.billingmanagementservice.rest.dto.BankAccount;
import com.billingmanagementservice.rest.adapter.RestAdapter;
import com.billingmanagementservice.rest.dto.BankAccountData;
import com.billingmanagementservice.domain.services.BankAccountDomainService;
...
public class BankAccountRestPort {
    ...
    public Transaction updateTransaction(Long transactionId, TransactionData data) throws Exception {
        ...
        VTransactionData vData = restAdapter.convertTransactionDataDtoToValue(data);
        return restAdapter.convertTransactionValueToDto(bankAccountDomainService.updateTransaction(transactionId, vData));

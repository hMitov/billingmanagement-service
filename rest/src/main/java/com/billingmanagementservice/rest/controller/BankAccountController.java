package com.billingmanagementservice.rest.controller;
...
import com.billingmanagementservice.rest.port.BankAccountRestPort;
...
@Api(tags = {"account"}, value = "BankAccount", produces = MediaType.APPLICATION_JSON_VALUE)

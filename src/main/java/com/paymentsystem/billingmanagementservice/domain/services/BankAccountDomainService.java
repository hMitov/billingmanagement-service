package com.paymentsystem.billingmanagementservice.domain.services;

import com.paymentsystem.billingmanagementservice.domain.adapter.DomainAdapter;
...
import com.paymentsystem.billingmanagementservice.domain.repository.BankAccountRepository;
import com.paymentsystem.billingmanagementservice.domain.repository.CardRepository;
import com.paymentsystem.billingmanagementservice.domain.repository.TransactionRepository;
...
public class BankAccountDomainService {
    ...
    public VTransaction updateTransaction(Long transactionId, TransactionData data) throws Exception {
    ...
    public boolean checkIfTransactionCompleted(Transaction transaction, TransactionData data) {
